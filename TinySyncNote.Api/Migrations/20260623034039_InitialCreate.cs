        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChangeVersion = table.Column<int>(type: "INTEGER", nullable: false),
                    ChangedByDeviceId = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SyncTrackings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RemoteVersion = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    ResolutionStrategy = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_NoteConflicts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NoteConflicts_Notes_NoteId",
                        column: x => x.NoteId,
                        principalTable: "Notes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SharedNoteCopyId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PublicShares_Notes_NoteId",
                        column: x => x.NoteId,
                        principalTable: "Notes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notebooks_UserId_IsSystem",
                table: "Notebooks",
                columns: new[] { "UserId", "IsSystem" });

            migrationBuilder.CreateIndex(
                name: "IX_NoteConflicts_NoteId",
                table: "NoteConflicts",
                column: "NoteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SyncTrackings_EntityType_EntityId",
                table: "SyncTrackings",
